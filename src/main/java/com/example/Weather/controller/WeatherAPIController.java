...
//    }
    ...
    @RequestMapping("/")
    public String getWeatherView(Model model, CountryCodes countryCodes) {
        model.addAttribute("codes", countryCodes.getAllCountryCodes());
        return "weather_view";
    }
    ...
    public String getFiveDayForecast(
        ...
        if (!fiveDay.isEmpty()) {
            ...
            model.addAttribute("daye", this.days);
